...
ej2_c<-ggplot(data=ds, mapping = aes(x=Temp9am, y=Pressure9am, colour=RainToday)) + geom_point()
ej2_c+labs(title='Probabilidad de lluvia segun condiciones atmosfericas', x='Temperatura', y='Presión atmosferica')
