...
?tseries::ice.river
ej6_a<-ggplot(data=ice.river.df, aes(y=time)) +geom_point(aes(x=flow.vat), colour='red')+geom_point(aes(x=flow.jok), colour='blue')
ej6_a

ej6_b<-ej6_a + labs(title='Caudal de ríos islandeses durante 3 años')
ej6_b
```
